...
public class CodeGeneration {
    ...
    {
        Node left = (Node) r.left;     //Identifier
        Node right = (Node) r.right;     //Identifier
    ...
    {
        Node left = (Node) r.left;     //Identifier
        Node right = (Node) r.right;     //Number
        if(!R.contains("s_"+left.lexeme.tokvalue))
        {
        R.add("s_"+left.lexeme.tokvalue);
        }
    ...
    {
        Node left = (Node) r.left;                      //Condition
